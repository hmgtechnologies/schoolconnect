...
const PRESETS = {
  'nurseryprimary': {
    ...
    modules: ['students','staff','classes','attendance','results','certificates','flyer','cbt','report-cards','analytics','admin-data','timetable-generator','checkin','diary','surveys','menu','settings','fees','messages','parents','gallery','birthdays','idcards','directory'],
  ...
  'tutorial': {
    ...
    modules: ['students','staff','attendance','results','idcards','certificates','flyer','cbt','report-cards','analytics','admin-data','timetable-generator','checkin','diary','surveys','menu','settings','fees','messages','gallery','eresources','directory','broadcast','voting'],
    levels:['JAMB Prep','WAEC Prep','GCE Prep','SAT Prep','IELTS Prep','A-Level Prep']
  },
  'tertiary': {
    name:'College / Tertiary', emoji:'🎓',
    modules: ['students','staff','classes','attendance','results','idcards','certificates','flyer','report-cards','analytics','admin-data','timetable-generator','checkin','diary','surveys','menu','settings','fees','cbt','library','eresources','announcements','events','gallery','directory','broadcast','hostel','voting'],
